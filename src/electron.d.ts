...
declare global {
  interface Window {
    xiaoyu?: {
      ...
      selectCustomImage: () => Promise<{ previewUrl: string; filePath: string; fileName: string; size: number } | null>
      ...
      generateVideo: (payload: { imageMode: 'ai' | 'upload'; imageSourceUrl: string; imageFilePath: string; audioFilePath: string; script: string; audioDuration: number; subtitles: boolean; resolution: '1080p' | '720p' }) => Promise<{ previewUrl: string; filePath: string; duration: number }>
